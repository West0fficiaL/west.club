...
.setColor('GREEN')
.setDescription('Başvurunuz Gönderildi En Kısa Sürede <#823282545797103646> Kanalından Cevap Vereceğiz!')
...
client.channels.cache.get('823282545797103646').send(embed2); 
};
exports.conf = {
    enabled: true,
    guildOnly: true,
